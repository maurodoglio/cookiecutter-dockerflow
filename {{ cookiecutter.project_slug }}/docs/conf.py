...
latex_documents = [
  ('index', '{{ cookiecutter.project_slug }}.tex', u'{{ cookiecutter.project_slug }} Documentation',
...
man_pages = [
    ('index', '{{ cookiecutter.project_slug }}', u'{{ cookiecutter.project_slug }} Documentation',
...
texinfo_documents = [
  ('index', '{{ cookiecutter.project_slug }}', u'{{ cookiecutter.project_slug }} Documentation',
   u'Mozilla Foundation', '{{ cookiecutter.project_slug }}', 'One line description of project.',
   'Miscellaneous'),
]
